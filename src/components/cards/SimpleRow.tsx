...
export function SimpleRow({ title, meta, trailing }: SimpleRowProps) {
  return (
    <View className="mb-3 flex-row items-start justify-between gap-3 rounded-xl border border-border dark:border-dark-border bg-card dark:bg-dark-card p-4 shadow-sm">
